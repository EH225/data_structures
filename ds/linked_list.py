...
class LinkedList:
    ...
    def addAtHead(self, val) -> None:
        """
        In-place method for adding a new node with val as the associated value to the linked list at 
        the head which becomes the new head node.
    ...
    def addAtIndex(self, index: int, val) -> None:
        ...
        :param index: An integer index value denoting the location in the linked list to add a new element
            An index of 0 is equlivalent to calling addAtHead.
        :param val: A value to be added to the linked list.
        :returns: None.
        """
